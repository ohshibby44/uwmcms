 ...
 */
$config_directories = array(
  CONFIG_SYNC_DIRECTORY => '../config/uwmedicineorg',
);
...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/uwmed/uwmedicineorg-settings.inc';
}
...
$config_directories['sync'] = '../config/uwmedicineorg';
$config_directories['vcs'] = '../config/uwmedicineorg';
